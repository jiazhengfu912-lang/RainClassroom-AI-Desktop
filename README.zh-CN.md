...
**0.1.2 修复了签名题图和全屏页面截图适配。已在真实课堂完成单选、多选、单空填空各 3 题，以及 3 道按 A/B 单选提交的判断练习；12 条提交均与重新读取的官方已保存答案一致。** 多空填空、真实断网恢复等仍待验收，详细证据见 [验证记录](docs/VALIDATION.md)。

## 使用

1. 安装本地交付的 `RainClassroom-AI-0.1.2-Setup.exe`，打开应用。
